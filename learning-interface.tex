...
The interface should reflect experiments executed in our world's domain and therefore should only present information to the agent that realistic acquisitional in our world's domain, this is to intentionally limit what of the observable state is that is directly exposed the agent.
